/* ============================================================
   REALITY FX — SVG icon set (line style, inherits currentColor)
   ------------------------------------------------------------
   Usage in JS-built HTML:  RFX.icons.shield
   Usage in static HTML:    <span class="ni-ic" data-icon="shield"></span>
                            (RFX.iconify() fills it automatically)
   ============================================================ */
...
(function () {
  ...
  const icons = {
    ...
    shieldCheck:S('<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 11.5 11.5 14 15.5 9.5"/>'),
    mail:       S('<rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22 6 12 13 2 6"/>'),
    ...
    columns:    S('<path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18"/>'),
    ...
    userCheck:  S('<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/>'),
    // status / actions
    ...
    crown:      S('<path d="M3 7l4.5 4L12 5l4.5 6L21 7l-1.6 11H4.6L3 7z"/><path d="M6 21h12"/>'),
    ...
    power:      S('<path d="M18.36 6.64a9 9 0 1 1-12.73 0"/><line x1="12" y1="2" x2="12" y2="12"/>'),
    ...
    receipt:    S('<path d="M4 2v20l2-1.5L8 22l2-1.5L12 22l2-1.5L16 22l2-1.5L20 22V2l-2 1.5L16 2l-2 1.5L12 2l-2 1.5L8 2 6 3.5 4 2z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="12" y2="16"/>'),
    ...
    smartphone: S('<rect x="6" y="2" width="12" height="20" rx="2"/><line x1="11" y1="18" x2="13" y2="18"/>'),
    ...
    sparkles:   S('<path d="M12 3l1.9 5.8L19.7 10l-5.8 1.9L12 17.7l-1.9-5.8L4.3 10l5.8-1.9L12 3z"/><path d="M19 15l.9 2.6 2.6.9-2.6.9L19 22l-.9-2.6-2.6-.9 2.6-.9L19 15z"/>'),
  ...
  window.RFX.icons = icons;

  window.RFX.iconify = function () {
  ...
  document.addEventListener('DOMContentLoaded', window.RFX.iconify);
})();
